...
Testfallen för saknat fält och tomt användarnamn testar grundläggande validering av indata.

Testfallen för felaktig OU och grupp är mer kopplade till AD-miljön. De kan användas när funktionerna för OU-kontroll och grupphantering testas.

Det är därför möjligt att alla testfall inte fångas av samma valideringsfunktion ännu.